...
export default function AstroPhotoPlanner({ open, onClose }) {
    ...
    return (
        <div className="fixed inset-y-0 right-0 w-full sm:w-[420px] max-w-full z-50 glass-panel overflow-y-auto animate-slideRight"
            ...
            <div className="sticky top-0 z-10 px-5 flex items-center gap-4 border-b border-cosmos-border/30 h-[64px] min-h-[64px]"
                ...
                <button onClick={onClose}
                    className="w-10 h-10 flex flex-shrink-0 items-center justify-center rounded-full hover:bg-cosmos-border/30 transition-colors text-cosmos-muted hover:text-cosmos-accent touch-manipulation" aria-label="Close">
